    ...
    <>
      ...
      <ul>
        <li>
          ...
          Pursuing a BS in Business Analytics @{" "}
        ...
        <li>
          ...
          Seeking a Position in Business or Data Analytics
        </li>
        <li>
          <span role="img" aria-label="laptop">
            💻
          </span>{" "}
          Currently building custom Regression Models for Financial Analysis in
          the{" "}
